...
function InterviewCard({interview}) {
    ...
    return (
        <div 
            className='border shadow-sm p-3 rounded-lg my-4 flex justify-between items-center cursor-pointer hover:bg-gray-50 transition-colors' 
        ...
        >
            <div>
                ...
                <h2 className='text-sm text-gray-600'>Experience: {interview?.jobExperience || 0} years</h2>
